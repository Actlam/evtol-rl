...
wp = [[[  0,  0, 40, 0], [3,4,5,18,19,20,63,64,65,78,79,80]], # Start
      ...
      [[100,  0, 50, 0], [6,7,8,21,22,23,66,67,68,81,82,83]],
      [[200,  0, 30, 0], [9,10,11,24,25,26,69,70,71,84,85,86]],
      [[200,  0, 40, 0], [9,10,11,24,25,26,69,70,71,84,85,86]],
      [[200,  0, 50, 0], [9,10,11,24,25,26,69,70,71,84,85,86]],
      ...
      [[  0,100, 30, 0], [21,22,23,33,34,35,81,82,83,93,94,95]],
      [[  0,100, 40, 0], [21,22,23,33,34,35,81,82,83,93,94,95]],
      [[  0,100, 50, 0], [21,22,23,33,34,35,81,82,83,93,94,95]],
      ...
      [[200,100, 30, 0], [27,28,29,87,88,89]],
      [[200,100, 40, 0], [27,28,29,87,88,89]],
      [[200,100, 50, 0], [27,28,29,87,88,89]],
      ...
      [[300,200, 30, 0], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[300,200, 40, 0], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[300,200, 50, 0], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[400,200, 30, 0], [45,46,47,54,55,56,105,106,107,114,115,116]],
      [[400,200, 40, 0], [45,46,47,54,55,56,105,106,107,114,115,116]],
      [[400,200, 50, 0], [45,46,47,54,55,56,105,106,107,114,115,116]],
      ...
      [[500,300, 30, 0], [999]], # Goal
      [[500,300, 40, 0], [999]], # Goal
      [[500,300, 50, 0], [999]], # Goal
      [[  0,  0, 30, 1], [3,4,5,18,19,20,63,64,65,78,79,80]],
      [[  0,  0, 40, 1], [3,4,5,18,19,20,63,64,65,78,79,80]],
      [[  0,  0, 50, 1], [3,4,5,18,19,20,63,64,65,78,79,80]],
      [[100,  0, 30, 1], [6,7,8,21,22,23,66,67,68,81,82,83]],
      [[100,  0, 40, 1], [6,7,8,21,22,23,66,67,68,81,82,83]],
      [[100,  0, 50, 1], [6,7,8,21,22,23,66,67,68,81,82,83]],
      [[200,  0, 30, 1], [9,10,11,24,25,26,69,70,71,84,85,86]],
      [[200,  0, 40, 1], [9,10,11,24,25,26,69,70,71,84,85,86]],
      [[200,  0, 50, 1], [9,10,11,24,25,26,69,70,71,84,85,86]],
      ...
      [[  0,100, 30, 1], [21,22,23,33,34,35,81,82,83,93,94,95]],
      [[  0,100, 40, 1], [21,22,23,33,34,35,81,82,83,93,94,95]],
      [[  0,100, 50, 1], [21,22,23,33,34,35,81,82,83,93,94,95]],
      ...
      [[300,200, 30, 1], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[300,200, 40, 1], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[300,200, 50, 1], [42,43,44,51,52,53,102,103,104,111,112,113]],
      [[400,200, 30, 1], [45,46,47,54,55,56,105,106,107,114,115,116]],
      [[400,200, 40, 1], [45,46,47,54,55,56,105,106,107,114,115,116]],
      [[400,200, 50, 1], [45,46,47,54,55,56,105,106,107,114,115,116]],
      ...
      [[500,300, 30, 1], [999]], # Goal
      [[500,300, 40, 1], [999]], # Goal
      [[500,300, 50, 1], [999]]] # Goal
...
# 外部にQテーブルとepsilonを保存する
def save(Q, epsilon, episode):
  with open('/home/lamcat/catkin_ws/src/energy/script/tmp_variables/q-table.binary', 'wb') as f:
    pickle.dump([Q, epsilon, episode], f)
    # print(epsilon, file=f)

# 外部に保存したQテーブルとepsilonを読み込む
def load():
  with open('/home/lamcat/catkin_ws/src/energy/script/tmp_variables/q-table.binary', 'rb') as f:
    Q, epsilon, episode = pickle.load(f)
  return Q, epsilon, episode

  # learn = []
  # with open('learn.txt', 'r', encoding='UTF-8') as temp_var:
  #   for i in temp_var:
  #     learn.append(i.rstrip('\n').lstrip('[]'))
  # if len(learn) != 0:
  #   Q = learn[0]
  #   epsilon = float(learn[1])
  # else:
  #   Q = []
  #   epsilon = 0
...
# ウェイポイントを操作する関数
# 引数でウェイポイント
def free_waypoint(x_lat=0, y_long=0, z_alt=10, wp_frame=6, wp_command=16, wp_param1=0, wp_param2=10):
  global init_lat
  global init_long
...
def create_push_wp_list(push_wp_list, wp_list):
  ...
  # ミッション終了後にplaneモードに遷移しホームポジションへ帰還
  push_wp_list.append(free_waypoint(wp_frame=2, wp_command=3000, wp_param1=4))
...
def get_action(s, Q, epsilon, pi_0):
  ...
  if np.random.rand() < epsilon:
    # εの確率でランダムに動く
    print('random_choice_action_list', wp[s][1])
...
def Q_learning(s,a,r,s_next,Q,eta,gamma):
  ...
  if s_next == 57 or s_next == 58 or s_next == 59 or s_next == 117 or s_next == 118 or s_next == 119:  #ゴール時
...
def main():
  ...
  # learn.txtに保存したQテーブルが存在するか確認し, 存在すればQに値を格納する
  # 保存されたQとepsilonがあるかチェック
  path = "/home/lamcat/catkin_ws/src/energy/script/tmp_variables/q-table.binary"
  q_table_binary_exist = os.path.isfile(path)
  ...
  while is_continue:
    ...
    save(Q, epsilon, episode)
    print('Qテーブルをlearn.txtに保存しました')
